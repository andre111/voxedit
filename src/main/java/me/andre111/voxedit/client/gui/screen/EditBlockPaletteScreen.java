...
public class EditBlockPaletteScreen extends Screen {
	...
	public EditBlockPaletteScreen(Screen parent, Text text, int minSize, boolean includeProperties, boolean showWeights, BlockPalette palette, Consumer<BlockPalette> callback) {
		super(text);
	...
	@Environment(value=EnvType.CLIENT)
	class BlockPaletteListWidget extends ModListWidget<me.andre111.voxedit.client.gui.screen.EditBlockPaletteScreen.BlockPaletteListWidget.BlockPaletteEntry> {
